        ...
        <div class="col-md-12">
            ...
            <form action="<?php echo ROOT_URL . '/api/comments/update.php' ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo ($numCom); ?>" readonly="readonly" />
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo ($numCom); ?>" readonly="readonly" />
                    <input id="numCom" name="numCom" class="form-control" type="text"
                        value="<?php echo ($numCom); ?>" />
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo ($numCom); ?>" readonly="readonly" />
                    <input id="dtModCom" name="dtModCom" class="form-control" type="text"
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo htmlspecialchars($numCom); ?>" readonly="readonly" />
                    <textarea id="libCom" name="libCom" class="form-control"
                        rows="10"><?php echo ($libCom); ?></textarea>
                </div>
                <br>

                <div class="form-group">
                    <label for="attModOK"><strong>En tant que modérateur, je valide le commentaire du membre
                            :</strong></label>
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo htmlspecialchars($numCom); ?>" readonly="readonly" />
                    <div>
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo htmlspecialchars($numCom); ?>" readonly="readonly" />
                    <textarea id="notifComKOAff" name="notifComKOAff" class="form-control"
                        rows="10"><?php echo ($notifComKOAff); ?></textarea>
                    <p>Vous pouvez ajouter une notification de rejet du post (propos difammatoires, injures,
                        vulgarité,...)</p>
                </div>

                <div class="form-group">
                    <label for="delLogiq"><strong>En tant que modérateur, je souhaite que le post ne soit pas/plus
                            affiché (suppression logique) :</strong></label>
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo htmlspecialchars($numCom); ?>" readonly="readonly" />
                    <div>
                        <label>
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                        value="<?php echo ($numCom); ?>" readonly="readonly" />
                    <input id="dtDelLogCom" name="dtDelLogCom" class="form-control" type="text"
