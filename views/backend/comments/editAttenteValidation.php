            ...
            <form action="<?php echo ROOT_URL . '/api/comments/update.php' ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="libTitrArt" name="libTitrArt" class="form-control" type="text"
                        value="<?php echo ($libTitrArt); ?>" readonly="readonly" />
                </div>
                <br>

                <div class="form-group">
                    <label for="pseudoMemb" for="dtCreaCom">
                        <h2>Information commentaire</h2>
                    </label>
                    ...
                    <input id="dtCreaCom" name="dtCreaCom" class="form-control" type="text"
                        value="<?php echo ($dtCreaCom); ?>" readonly="readonly" />
                </div>
                <br>
                ...
                <div class="form-group">
                    ...
                    <textarea id="libCom" name="libCom" class="form-control"
                        rows="6"><?php echo ($libCom); ?></textarea>
                </div>
                <br>

                <div class="form-group"></div>
                <label for="attModOK">
                    <h2>Validation du commentaire</h2>
                </label>
                <input id="numCom" name="numCom" class="form-control" style="display: none" type="text"
                    value="<?php echo ($numCom); ?>" readonly="readonly" />
                <br>
                <label>
                    <input type="radio" name="attModOK" value="1" <?php echo ($attModOK == 1) ? 'checked' : ''; ?>>
                    Valider le commentaire
                </label>
                <br>
                <label>
                    <input type="radio" name="attModOK" value="0" <?php echo ($attModOK == 0) ? 'checked' : ''; ?>>
